  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`p-3 bg-card/80 border border-border hover:bg-muted rounded-full backdrop-blur-md shadow-lg transition-colors ${
      ...
      >
        <div className="flex items-center gap-4 bg-card/80 border border-border rounded-full px-5 py-2 backdrop-blur-md shadow-lg w-max">
          <button
            onClick={togglePlay}
